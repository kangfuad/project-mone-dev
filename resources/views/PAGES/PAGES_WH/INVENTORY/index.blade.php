                            ...
                            <table id="poList"
                                ...
                                <tbody>
                                    @foreach($data as $data)
                                        <tr class="">
                                            <td width="2%" class="">{{$loop->iteration}}</td>
                                            <td width="15%" class="">{{$data->kode_barang}}</td>                                            
                                            <td width="15%" class="">{{$data->nama_barang}}</td>                                            
                                            <td width="10%" class="">{{$data->Kategori_barang}}</td>
                                            <td width="15%" class="">{{$data->jumlah}}</td>                                            
                                            <td width="15%" class=""><span class="badge badge-soft-success">{{$data->satuan}}</span></td>                                            
                                            <td width="10%" class="">
